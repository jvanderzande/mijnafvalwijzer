...
local notificationtitle = 'AF-WFR: @DAG@ de @AFVALTEXT@ aan de weg zetten!'
...
function dprint(text)
   if debug then print("@AF-WFR:"..text) end
end
...
function Perform_Update()
   print('AF-WFR module start check')
   dprint('=== web update ================================')
   -- get data from the website
   local commando = "curl --max-time 5 -s \"https://afvalkalender.sudwestfryslan.nl/adres/"..Postcode..":"..Housenr.."\""
   dprint(commando)
